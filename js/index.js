...
(function (window){
  ...
  Sakri.CanvasTextProperties = function(fontWeight, fontStyle, fontSize, fontFace){
    ...
    this.fontFace = fontFace ? fontFace : "KyoMadoka";
  };
...
var maxStageWidth = 3000;
var maxStageHeight = 1500;
...
function commitResize(){
    ...
    textInputSpan.style.top = htmlBounds.getCenterY() + (bounds.height/2) + 20 +"px";//toppppppppp
    textInputSpan.style.left = (htmlBounds.getCenterX() - getWidth(textInputSpan)/2)+"px";//leftttt
